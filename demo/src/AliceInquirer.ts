...
export class AliceInquirer extends BaseInquirer {
  ...
  private async getPromptChoice() {
    ...
    const reducedOption = [PromptOptions.CreateConnection, PromptOptions.ListCredentials, PromptOptions.Exit, PromptOptions.Restart]
  ...
  public async getCredentials() {
    await this.alice.getCredentials()
  }
